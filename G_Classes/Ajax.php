<?php
     ...
     class Ajax {
          ...
          function Ajax($htmlObjectId) {
               print '<script src="./library/js/ajax.js" type="text/javascript"></script>';
               print "<script type=\"text/javascript\" language=\"JavaScript\"> createRequestObject('$htmlObjectId');</script>";
          }

          /**
           * This function calls the remote file with certain parameters
           *
