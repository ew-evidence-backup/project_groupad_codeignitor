 ...
 */
     ...
     class EyeDataGrid {
          ...
          public function __construct(EyeMySQLAdap $_db, $image_path = '') {
               ...
               if (empty($image_path)) {
                    $this->image_path = '/library/images/';
               }
               else
               {
          ...
          private function buildHeader() {
               ...
               foreach ($headers as $t)
               {
                    ...
                    if ($this->hide_order) {
                         echo '<td class="tbl-header">' . $header;
          ...
          private function buildFooter($shown, $first = 0, $last = 0) {
               ...
               if ($pages > 0) {
                    ...
                    {
                         echo $this->page;
                    } // Just write the page number, nothing to fancy
          ...
          public function printTable() {
               ...
               if ($this->row_count == 0) {
                    ...
                    {
                         echo '<tr class="tbl-row tbl-row-' . (($i % 2) ? 'odd'
