...
class StreamPublish
{
     ...
     */
    public function SetNameUrl($nameUrl) {$this->nameUrl = $nameUrl;}
     ...
     */
    public function SetUserMessage($userMessage) {$this->userMessage = $userMessage;}
   ...
   /**
     ...
     */
    public function SetOnPublishJavaScript($onPublishJavaScript) {$this->onPublishJavaScript = $onPublishJavaScript;}

    /**
     * Function sets the form ID to be submitted after the story is published.
     * @param <string> $onPublishSubmitForm
     */
    public function SetOnPublishSubmitForm($onPublishSubmitForm) {$this->onPublishSubmitForm = $onPublishSubmitForm;}
     ...
     */
    public function SetDisplayPopup($displayPopup) { $this->displayPopup = $displayPopup;}

    /**
     * Add property/linked property to propery list
     * @param <Property> $property 
     */
    public function AddPropery($property) { $this->properties[] = $property; }

    /**
     * Add action link to action links list
     * @param <ActionLink> $actionLink
     */
    public function AddActionLink($actionLink) { $this->actionLinks[] = $actionLink; }
